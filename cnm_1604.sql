...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `lop_id_foreign` (`lopId`) USING BTREE,
  CONSTRAINT `lop_id_foreign` FOREIGN KEY (`lopId`) REFERENCES `classes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table cnm_db.users: ~3 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `maso`, `hodem`, `ten`, `lopId`, `hinhanh`, `email`, `type`, `phone`, `matKhau`, `refreshToken`) VALUES
	...
	(3, '20012781', 'Phan Hoài', 'An', 1, NULL, 'le4@gmail.com', 'student', '0973743580', '$2b$10$EkGnO9bDJqNx4.xvAT9tBe5bC4icTGsO2Dpq0lzMAuGA3yWDAljoS', NULL),
