...
INSERT INTO `classes` (`id`, `maLop`, `ten`, `startDate`, `endDate`, `gvId`, `khoaId`) VALUES
	(1, 'DHHTTT16A', 'DHHTTT16A', '2024-04-15', '2024-06-15', 2, 1),
...
-- Dumping data for table cnm_db.companies: ~4 rows (approximately)
...
INSERT INTO `companies` (`id`, `sinhvien`, `status`, `lop`, `gv`, `tenCongTy`, `startDate`, `endDate`, `viTri`) VALUES
	...
	(4, 1, '1', 1, 3, 'QASOFT Solution', '2024-05-11', '2024-05-11', 'Web developer'),
	(5, 8, '0', 1, 2, '123', '2024-05-24', '2024-07-27', '123');
...
-- Dumping data for table cnm_db.files: ~6 rows (approximately)
DELETE FROM `files`;
/*!40000 ALTER TABLE `files` DISABLE KEYS */;
INSERT INTO `files` (`id`, `date`, `report_type`, `report_file`, `sv_id`, `commit`, `key`) VALUES
	(13, '2024-05-26', '1', 'PhongVan.docx', 1, 'update thành file pv', '2214f4cfa24007a677bc0fde794ad0150f60fb1a7a8496da07a0844e9fc43afd'),
	(14, '2024-05-20', '4', 'Tuan_08_NguyenThiLe_20012011.docx', 1, 'Nộp báo cáo tuần 04', '2887f254d0fcbfe3f7cfc4287ddac0d2163228aed36097e21a18e0611f26a446'),
	(15, '2024-05-23', '2', 'Nhom04_BaitapTK_01_HÃ_TNDN.docx', 8, 'test sv00', '71eff278148a1563a0a7d1f59458ffc93d18a420a3ada04f67c4820c0dbd2582'),
	(16, '2024-05-26', '2', 'PhongVan.docx', 1, 'Báo cáo phỏng vấn tuần 01', '665d4f1c57293ea463abc7c80e54ae081839e40584c558e938559f366e381a2a'),
	(17, '2024-05-26', '9', 'CCCD_NguyenThiLe.pdf', 1, 'Báo cáo tuần 09 ạ', '1ae1dce9b5da8e10b393a9c0d49720b3da76cea901f443a72a6b909352804f07'),
	(19, '2024-05-26', '0', 'CV_NGUYENTHILE_FULLSTACK.pdf', 1, 'Báo cáo tổng hợp cuối kỳ', '8fbe3738d2ea2d004e9adf4593e762fa3da888d58c51d3b136d4d97609cd75ab');
/*!40000 ALTER TABLE `files` ENABLE KEYS */;

-- Dumping structure for table cnm_db.reports
CREATE TABLE IF NOT EXISTS `reports` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ngay_bao_cao` date DEFAULT NULL,
  ...
  CONSTRAINT `FK_reports_students` FOREIGN KEY (`sv`) REFERENCES `students` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table cnm_db.reports: ~2 rows (approximately)
DELETE FROM `reports`;
/*!40000 ALTER TABLE `reports` DISABLE KEYS */;
INSERT INTO `reports` (`id`, `ngay_bao_cao`, `diem`, `danhgia`, `diemDN`, `sv`) VALUES
	(4, NULL, 9, 'Cần nộp đủ file báo cáo trước hạn', 8, 1),
	(5, NULL, NULL, '', NULL, 6);
...
INSERT INTO `students` (`id`, `maso`, `hodem`, `ten`, `lopId`, `gvId`, `hinhAnh`, `email`, `phone`, `matKhau`, `refreshToken`) VALUES
	...
	(3, 'SV02', 'Nguyen Van', 'A', 1, 2, NULL, 'admin', '0999999999', '$2b$10$ZYf6.PuYxY/do9h.i8xZsugw3I/u6BGSq3b7pZvwgLnnDm57sFKVW', NULL),
	(4, '20050981', 'Nguyen Quang', 'Tu', 1, 2, NULL, 'nguyenquangtu2301@gmail.com', '0839256698', '$2b$10$S.Dsweo4T1D7YbB9lxa6Eew9VZSDOHhw6KHpdxMI4D59VLiaBtQvu', NULL),
	(5, 'SV009', 'Nguyen Van', 'A', 1, 2, NULL, 'admin', '0839256698', '$2b$10$izWlV/OL4llhHJsvYzqWo.0H5YuDfncN5iiyhDTlzUMGsDXv..fly', NULL),
	(6, '205009', 'Nguyen Quang', 'Tu', 1, 2, NULL, 'nqt', '099933344', '$2b$10$xlGkxq1vsCdMRPJMy2x0N.kim4hu7inv0OyHqM4aJcRImCOXKbFUW', NULL),
	(7, '0000001', 'Nguyá»…n VÄƒn ', 'T', 1, 2, NULL, 'admin', '00022222', '$2b$10$qvtJn95oaCc6/IPvUBATHuvOBC8M0NMy5mWzcB5QksSFs38OB/rn.', NULL),
	(8, 'sv000', 'Nguyen ', 'Tu', 1, 3, NULL, 'admin', '011111112222', '$2b$10$vXXR7TEwkPOyg1jnVyFkoOPxK.VfYvVTK4im7pFnpaJ3OilyWwcJS', NULL);
...
INSERT INTO `users` (`id`, `maso`, `hodem`, `ten`, `khoaId`, `hinhanh`, `email`, `type`, `phone`, `matKhau`, `refreshToken`) VALUES
	(2, '200120111', 'Nguyễn Thị', 'Lê', 1, NULL, 'le4@gmail.com', 'teacher', '0973743580', '$2b$10$0gTYPGVUVrNuZIXwqNvh6etCVljphKQZWWBDxZ91SOnJPNkr4GQka', NULL),
